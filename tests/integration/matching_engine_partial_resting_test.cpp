...
// Verifies that partially filled resting orders remain in the order book.
TEST(MatchingEnginePartialRestingTest, KeepsRemainingRestingQuantityAfterPartialFill)
{
